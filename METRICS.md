...
> **Version 0.1.68** · Generated 2026-07-28 15:40 · **357 modules** · **464 metrics**
>
> `ayase modules docs -o METRICS.md` to regenerate
>
> Tests: **350/357 modules** have static test references · `pytest tests/` (light) · `pytest tests/ --full` (with ML models)

## Summary

**357** modules · **550** output fields · **464** metrics · **252** tiered · **168** GPU · **22** categories
...
[No-Reference Quality](#no-reference-quality-83-metrics) (83) · [Full-Reference Quality](#full-reference-quality-89-metrics) (89) · [Text-Video Alignment](#text-video-alignment-60-metrics) (60) · [Temporal Consistency](#temporal-consistency-30-metrics) (30) · [Motion & Dynamics](#motion--dynamics-34-metrics) (34) · [Basic Visual Quality](#basic-visual-quality-16-metrics) (16) · [Aesthetics](#aesthetics-13-metrics) (13) · [Audio Quality](#audio-quality-43-metrics) (43) · [Face & Identity](#face--identity-22-metrics) (22) · [Scene & Content](#scene--content-19-metrics) (19) · [Distribution & Generation](#distribution--generation-1-metrics) (1) · [HDR & Color](#hdr--color-13-metrics) (13) · [Codec & Technical](#codec--technical-4-metrics) (4) · [Depth & Spatial](#depth--spatial-5-metrics) (5) · [Production Quality](#production-quality-5-metrics) (5) · [OCR & Text](#ocr--text-7-metrics) (7) · [Safety & Ethics](#safety--ethics-9-metrics) (9) · [Image-to-Video Reference](#image-to-video-reference-5-metrics) (5) · [Meta & Curation](#meta--curation-5-metrics) (5) · [Dataset-Level Metrics](#dataset-level-metrics-86-fields) (86) · [Utility & Validation](#utility--validation-30-modules) (30)
...
**[`love_results`](src/ayase/modules/love.py)** — LOVE perception and text-video correspondence result adapter
...
- **Tests**: covered by [`test_mj_video.py`](tests/modules/per_module/test_mj_video.py) · live: ✅⏳
...
**[`phyground_results`](src/ayase/modules/phyground.py)** — PhyGround general and physical-law judge result adapter
...
**[`ref4d_results`](src/ayase/modules/ref4d.py)** — Ref4D semantic, event, motion, and world result adapter
...
## Full-Reference Quality (89 metrics)
...
## Temporal Consistency (30 metrics)
...
- **Tests**: covered by [`test_chronomagic.py`](tests/modules/per_module/test_chronomagic.py), [`test_vbench2_compbench.py`](tests/modules/test_vbench2_compbench.py) · live: ✅⏳
...
- **Tests**: covered by [`test_dynamics_controllability.py`](tests/modules/per_module/test_dynamics_controllability.py), [`test_fields_general.py`](tests/modules/test_fields_general.py), [`test_opencv_modules.py`](tests/modules/test_opencv_modules.py), +2 more · live: ✅⏳
- **Config**: `subsample=16`
...
- **Input**: vid · **Speed**: ⚡ fast
- **Backend**: algorithmic
- **Tests**: covered by [`test_motion.py`](tests/modules/per_module/test_motion.py), [`test_result_adapters.py`](tests/modules/per_module/test_result_adapters.py), [`test_vbench2_compbench.py`](tests/modules/test_vbench2_compbench.py), +4 more · live: ✅⏳
...
- **Packages**: torch
- **Source**: <a href="https://huggingface.co/facebookresearch/co-tracker" target="_blank">HF</a>
- **Tests**: covered by [`test_physics.py`](tests/modules/per_module/test_physics.py), [`test_vbench2_compbench.py`](tests/modules/test_vbench2_compbench.py) · live: ✅⏳
...
- **Input**: img/vid · **Speed**: ⚡ fast
- **Tests**: covered by [`test_fvmd.py`](tests/modules/per_module/test_fvmd.py), [`test_dataset_modules.py`](tests/modules/test_dataset_modules.py), [`test_fields_general.py`](tests/modules/test_fields_general.py), +1 more · live: ✅⏳
...
- **Tests**: covered by [`test_vbench2.py`](tests/modules/per_module/test_vbench2.py) · live: ✅⏳
...
- **[`audio`](src/ayase/modules/audio.py)** — Validates audio stream quality and presence · Input: vid · Speed: ⚡ fast · Tests: covered by [`test_audio.py`](tests/modules/per_module/test_audio.py), [`test_docs_integrity.py`](tests/test_docs_integrity.py), [`test_integration_synthetic.py`](tests/test_integration_synthetic.py) · live: ✅⏳
...
- **[`metadata`](src/ayase/modules/metadata.py)** — Checks video/image metadata (resolution, FPS, duration, integrity) · Input: img/vid · Speed: ⚡ fast · Tests: covered by [`test_camerabench.py`](tests/modules/per_module/test_camerabench.py), [`test_grid_layout.py`](tests/modules/per_module/test_grid_layout.py), [`test_metadata.py`](tests/modules/per_module/test_metadata.py), +6 more · live: ✅⏳
