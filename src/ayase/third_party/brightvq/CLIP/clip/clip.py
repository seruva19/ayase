...
_ENV_MODEL_PATHS = {
    "ViT-B/32": "AYASE_BRIGHTVQ_CLIP_VIT_B32_PATH",
    "ViT-L/14": "AYASE_BRIGHTVQ_CLIP_VIT_L14_PATH",
}
...
def load(name: str, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", jit: bool = False, download_root: str = None):
    ...
    """
    env_model_path = os.environ.get(_ENV_MODEL_PATHS.get(name, ""))
    if env_model_path and os.path.isfile(env_model_path):
        ...
        model_path = _download(
            _MODELS[name],
            download_root
            or os.environ.get("AYASE_BRIGHTVQ_CLIP_DOWNLOAD_ROOT")
