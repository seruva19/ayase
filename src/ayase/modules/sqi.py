...
Category: IMPOSSIBLE.
Why requires_external_backend: Combines FR-VQA with live STALL / REBUFFERING telemetry from a streaming session;
...
To revive: Not revivable here -- the required streaming session telemetry cannot be derived from a
  media file on disk. Permanent; keep requires_external_backend or delete.
